...
import type { BackEndPlayer as Player, BackEndProjectile as Projectile } from '@/types';
...
const backEndPlayers: { [key: string]: Player } = {};
const backEndProjectiles: { [key: number]: Projectile } = {};
